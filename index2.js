...
// Añadimos la importación de tu archivo AGB
...
// --- SAMPLES DE AGB (Tu parte añadida) ---
app.get("/samples/AGB", (req, res) => {
    // Usamos la función que has creado en index-AGB.js pasándole tus datos exportados
